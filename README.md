...
### Примечания по выбору способа запуска

| Способ | Когда использовать |
|--------|-------------------|
| **Docker** | Быстрый старт, CI/CD, демонстрация работы, командная разработка |
| **Локально** | Отладка тестов, написание новых сценариев |
| **IDE** | Пошаговая отладка, запуск отдельных тестов |
